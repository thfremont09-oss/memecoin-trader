...
Write-Host "Logs:       data\trader.log is the most reliable one (written directly by"
Write-Host "            Python). data\engine_watchdog.log / dashboard_watchdog.log have"
Write-Host "            start/restart messages; *_stdout.log / *_stderr.log have raw"
Write-Host "            console output if a process won't start at all."
